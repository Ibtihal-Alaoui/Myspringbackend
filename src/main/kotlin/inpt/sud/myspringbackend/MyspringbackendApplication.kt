...
import inpt.sud.myspringbackend.dao.CategoryRepository
import inpt.sud.myspringbackend.dao.ProductRepository
import inpt.sud.myspringbackend.data.Category
...
class MyspringbackendApplication: CommandLineRunner{
    @Autowired
...
fun main(args: Array<String>) {
    runApplication<MyspringbackendApplication>(*args)
}
